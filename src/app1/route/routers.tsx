...
export const router: RouterType[] = [
    {
        title: "HomePage", path: "/App1/HomePage", component: HomePage, exact: false, childrenRoute: [
            { title: "Listing", path: "/App1/HomePage/Listing", component: Listing, exact: true, icon: <ClipboardListStrokeIcon /> },
            { title: "WatchList", path: "/App1/HomePage/WatchList", component: WatchList, exact: true, icon: <LineGraphFillIcon /> },
            { title: "Hodings", path: "/App1/HomePage/Hodings", component: Hodings, exact: true, icon: <ClipboardListFillIcon /> },
            { title: "Orders", path: "/App1/HomePage/Orders", component: Orders, exact: true, icon: <BookClosedFillIcon /> },
            { title: "UserProfile", path: "/App1/HomePage/UserProfile", component: UserProfile, exact: true, icon: <UserListFillIcon /> },
        ]
    }
];
