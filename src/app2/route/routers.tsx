...
export const router: RouterType[] = [
    {
        title: "HomePage", path: "/App2/HomePage", component: HomePage, exact: false, childrenRoute: [
            { title: "Listing", path: "/App2/HomePage/Listing", component: Listing, exact: true, icon: <ClipboardListStrokeIcon /> },
            { title: "WatchList", path: "/App2/HomePage/WatchList", component: WatchList, exact: true, icon: <LineGraphFillIcon /> },
            { title: "Hodings", path: "/App2/HomePage/Hodings", component: Hodings, exact: true, icon: <ClipboardListFillIcon /> },
            { title: "Orders", path: "/App2/HomePage/Orders", component: Orders, exact: true, icon: <BookClosedFillIcon /> },
            { title: "UserProfile", path: "/App2/HomePage/UserProfile", component: UserProfile, exact: true, icon: <UserListFillIcon /> },
        ]
    }
];
